...
-   #### First Time Visitor Goals
    ...
    2. As a First Time Visitor, I want to be able to easily navigate throughout the site to find content.
        ...
        1. The site has been designed to be fluid and never to entrap the user. At the top of each page there is a clean navigation bar, where each link clearly describes what page they will end up at.
...
-   Add Social media to testimonials page.
-   Fix testimonial forms.
-   Fix email to originate from great.graphics.com
